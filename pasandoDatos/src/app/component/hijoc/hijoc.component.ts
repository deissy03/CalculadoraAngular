...
export class HijocComponent {
  ...
  @Output() contadorHijoChange = new EventEmitter<number>();// aqui el output se crea una clase que nos define una propiedad de salida llamada contadorHijoChange, usamos una clase llamada EventEmitter que viene de angular lo que permite enviar datos del componente principal
//aqui creo dos funciones sumar y restar luego emito el valor que recibi a la variable contador 
  sumar(){ 
    this.contador++; 
    this.contadorHijoChange.emit(this.contador);
  }
